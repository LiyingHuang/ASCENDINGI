...
public class ConsumerJDBCDao {
    static final String DBURL = "jdbc:postgresql://localhost:5431/dealer2";
    static final String USER = "admin";
    static final String PASS = "password";
    private Logger logger = LoggerFactory.getLogger(getClass());
    public List<ConsumerJDBC> getConsumers() {
        List<ConsumerJDBC> consumers = new ArrayList();
    ...
    public static void main(String[] args){
        ConsumerJDBCDao consumerJDBCDao = new ConsumerJDBCDao();
